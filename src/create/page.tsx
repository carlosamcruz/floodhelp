...
export default function Home() {
    ...
    function onInputChange(evt: { target: { id: any; value: any; }; }){
        setRequest(prevState => ({...prevState, [evt.target.id]: evt.target.value}))
    }

    function btnSaveClick(){
        alert("inciando processo de salvamento...")
        openRequest(request)
        .then( result => {
            alert("Pedido salvo com sucesso. Em alguns minutos estará disponível na pagina principal.")
          ...
          <div className="ps-5">
            ...
            <div className="col-6">
                <div className="form-floating mb-3">
                    ...
                    value={request.title} onChange={onInputChange} ></input>
            ...
            <div className="col-6">
                <div className="form-floating mb-3">
                    <textarea id="description" className="form-control" style={{height: 100}}
                     value={request.description}  onChange={onInputChange} ></textarea>
                    <label htmlFor="description">Descreva detalhes do que precisa e onde você está para entregas presenciais:</label>
                </div>
            </div>
            <div className="col-6">
                <div className="form-floating mb-3">
                    <input type="text" id="contact" className="form-control" maxLength={150} 
                    value={request.contact}  onChange={onInputChange} ></input>
            ...
            <div className="col-6">
                <div className="form-floating mb-3">
                    ...
                    value={request.goal}  onChange={onInputChange} ></input>
                    <label htmlFor="goal">Meta em ETH ou BNB (deixe em branco caso não deseje receber doação em cripto):</label>
                </div>
            </div>
            <div className="row">
